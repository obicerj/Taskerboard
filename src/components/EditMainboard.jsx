...
import { useUpdateMainboard } from '../hooks/useMainBoardData'

const EditMainboard = ({mainboardName, mainboardId}) => {
    const [editMainboardName, seteditMainboardName] = useState(mainboardName)
